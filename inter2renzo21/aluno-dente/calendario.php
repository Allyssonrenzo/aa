...
<head>
    ...
    <style>
        ...
        .container { 
            ...
            margin-top:10px;  box-shadow: 0 0 10px rgba(0, 0, 0, 0.1); /* Sombra suave */
        }
        ...
        .button:hover {
            background-color: #3e95f7; /* Tom mais escuro ao passar o mouse */
        }

        a {
            color: #3b60ed; /* Azul para os links */
            text-decoration: none;

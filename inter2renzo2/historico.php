                    ...
                    <tr>
                        ...
                        <td>
                            <?php if ($value['dt'] >= $dataAtual) { ?>
                                ...
                                <?php if ($value['funcionario'] === 'cezar') { ?>
                                    <form method="GET" action="./aluno/crud.php">
                                <?php } elseif ($value['funcionario'] === 'julio') { ?>
                                    <form method="GET" action="./aluno-dente/crud.php">
                                <?php } ?>
                            ...
                            <?php if ($value['funcionario'] === 'cezar') { ?>
                                    <form method="GET" action="./aluno/avaliar.php">
                                <?php } elseif ($value['funcionario'] === 'julio') { ?>
                                    <form method="GET" action="./aluno-dente/avaliar.php">
                                <?php } ?>
                                ...
                                <button name="excluir2" type="submit" class="button">Avaliar</button>
                            </form>
                        </td>
                    </tr>
                <?php
